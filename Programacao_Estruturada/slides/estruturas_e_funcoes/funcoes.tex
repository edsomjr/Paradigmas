...
\begin{frame}[fragile]{Funções}
    ...
    \begin{itemize}
        ...
        \item O bloco de comandos pode ser encerrado por meio do comando \code{fortran}{return}
...
\begin{frame}[fragile]{Exemplo de declaração e uso de funções}
    \inputsnippet{fortran}{1}{17}{codes/binom.f90}
\end{frame}

\begin{frame}[fragile]{Exemplo de declaração e uso de funções}
    \inputsnippet{fortran}{19}{45}{codes/binom.f90}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de declaração e uso de subrotinas}
    \inputsnippet{fortran}{1}{18}{codes/selection.f90}
\end{frame}

\begin{frame}[fragile]{Exemplo de declaração e uso de subrotinas}
    \inputsnippet{fortran}{20}{36}{codes/selection.f90}
\end{frame}

\begin{frame}[fragile]{Exemplo de declaração e uso de subrotinas}
    \inputsnippet{fortran}{38}{66}{codes/selection.f90}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de subrotina em Fortran}
    \inputsnippet{fortran}{1}{16}{codes/fibonacci.f90}
\end{frame}

\begin{frame}[fragile]{Exemplo de subrotina em Fortran}
    \inputsnippet{fortran}{17}{45}{codes/fibonacci.f90}
\end{frame}
