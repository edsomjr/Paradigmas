...
\begin{frame}[fragile]{Exemplo de uso do construto {\tt IF-ELSE}}
    \inputsnippet{fortran}{1}{18}{codes/irrf.f90}
\end{frame}

\begin{frame}[fragile]{Exemplo de uso do construto {\tt IF-ELSE}}
    \inputsnippet{fortran}{19}{45}{codes/irrf.f90}
\end{frame}
...
\begin{frame}[fragile]{Exemplo de uso do construto {\tt SELECT-CASE}}
    \inputsnippet{fortran}{1}{18}{codes/priority.f90}
\end{frame}

\begin{frame}[fragile]{Exemplo de uso do construto {\tt SELECT-CASE}}
    \inputsnippet{fortran}{19}{45}{codes/priority.f90}
\end{frame}
