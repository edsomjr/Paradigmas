...
\begin{frame}[fragile]{Exemplo de código procedural escrito em C}
    \inputsnippet{c}{1}{18}{codes/coin_change.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de código procedural escrito em C}
    \inputsnippet{c}{20}{40}{codes/coin_change.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de código procedural escrito em C}
    \inputsnippet{c}{42}{61}{codes/coin_change.c}
\end{frame}

\begin{frame}[fragile]{Exemplo de código procedural escrito em C}
    \inputsnippet{c}{61}{81}{codes/coin_change.c}
\end{frame}
