...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[] (moses) at (3.0, 4.0) { \includegraphics[scale=0.3]{figs/moses2.png} };

	\node[anchor=west] (flag) at (1.2, 1.5) { \includegraphics[scale=0.015]{figs/ucrania.png} };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (a) at (1.0, 5.0) { $\star$ \bbbold{SCHÖNFINKEL}\bbtext{, Moses.} \bbenglish{On the building blocks of the mathematical logic.} };

	\node[anchor=west] (a1) at (0.5, 4.25) { \bbtext{Mathematische Annalen (in German). 92 (3–4): 305–316, 1924.} };

	\node[anchor=west] (b) at (1.0, 3.5) { $\star$ \bbbold{O'LEARY}\bbtext{, Daniel J.} \bbenglish{The Propositional Logic of Principia Mathematica and Some} };

	\node[anchor=west] (b1) at (0.5, 2.75) { \bbenglish{of Its Forerunners·} \bbtext{Russell: The Journal of Bertrand Russell Studies 8 (1) (1988).} };

	\node[anchor=west] (c) at (1.0, 2.0) { $\star$ \bbbold{FILHO}\bbtext{, Edgard de Alencar.} \bbenglish{Introdução à Lógica Matemática.} \bbtext{Nobel, 2009.} };
