...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (b1) at (1.25, 4.0) { $fxy = fx(Kyx) = fx((Ky)x) = Sf(Ky)x$ };
...
\node[draw,opacity=0] at (14, 8) {x};
	...
	\node[anchor=west] (d) at (1.0, 1.5) { $\star$ \bbtext{Ele esteve muito próximo de um resultado fundamental, mas não o enunciou:} };
